...
import { showWelcomeModal } from "../../../../features/user/userSlice";

const UserWelcomeBack = () => {
          ...
          <div className="bg-white overflow-hidden rounded-3xl flex flex-col md:flex-row items-center w-full ">
            ...
            <div className="p-6 w-full">
              ...
              <div className="mt-4">
                ...
                Welcome back to <span className=" font-semibold"> Carbosense.</span> Continue your journey by tracking
                  your environmental impact and making a lasting difference
                  together!
                </p>
                <SizedBox height={"h-4"} />
                <Button
                  ...
                  callback={() => dispatch(showWelcomeModal(false))}
                />
              </div>
            </div>
          </div>
...
export default UserWelcomeBack;