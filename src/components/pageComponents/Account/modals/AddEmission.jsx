...
//             Your emission reports would appear here{" "}
//           </p>
//         </div>
...
//               Please enter a valid numeric value for the Emission Value field.
//             </p>
//           )}
//           <SizedBox height={"h-6"} />
//           <Button
...
//               !values.source ||
//               !values.source.value ||
//               !values.emissionRegion ||
//               !values.emissionRegion.value ||
//               !values.emissionFactor ||
//               !values.emissionFactor.value ||
//               !values.emissionUnit ||
//               !values.emissionUnit.value ||
//               !values.emissionValue ||
//               !isEmissionValueValid() ||
//               addUserEmissionMutation.isPending
//             }
//           />
...
const AddEmission = () => {
  ...
  const handleSubmit = () => {
    ...
    console.log(submissionObject, "OBJECT");
