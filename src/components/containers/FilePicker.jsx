  ...
  return (
    <>
      <label
        htmlFor="file"
        className={twMerge(
          "flex flex-col justify-center items-center border-2 border-dashed border-[#285FCD] py-6 dashed-border-vertical transition-all cursor-pointer hover:bg-gray-200",
          width ?? "w-[240px]",
      ...
      >
        ...
        <SizedBox height="h-4" />
        <p className="text-lg text-primary-black text-center font-medium">
          Drag and drop files, or browse
        </p>
        <SizedBox height="h-2" />
        <p className="text-primary-black text-center text-sm">
